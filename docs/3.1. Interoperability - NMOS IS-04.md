...
**Example 1:** The 'controls' attribute of the NMOS Device of a simple Node with a single device and Audio Channel Mapping API instance
...
**Example 2:** The 'controls' attribute of an NMOS Device of a Node which advertises a different Audio Channel Mapping API instance for each device
