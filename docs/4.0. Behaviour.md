...
TODO: These blocks are inconsistent with the requirement that each block must start with an index equal to a multiple of the block size. How to rectify?

![reordering constraint example](images/input-constraints-no-reordering.png "Permissible routing with blocks of 8")

TODO: add a picture of Signals 1-8 routed to MADI Card B, or Signals 9-16 routed to MADI Card A.
