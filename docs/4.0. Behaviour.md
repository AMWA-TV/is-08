...
![block constraint example](images/input-constraints-block-no-reordering.png "Permissible routing with blocks of 8")

![block constraint example](images/input-constraints-block-crossover.png "Routing with blocks of 8 and crossover")

The following examples would not be permissible:

![block constraint example](images/input-constraints-block-input-gap.png "All of a block must be routed.")

![block constraint example](images/input-constraints-block-reordering.png "Crossing Over within blocks is not permitted.")
...
![re-entrant mapping example](images/madi-example.png "Re-entrant mapping example")
