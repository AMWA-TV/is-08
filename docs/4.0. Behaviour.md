...
Consider a case where the specific architecture of a given MADI Card only allows processing of Input channels 0-7, or 8-15, or 16-23, and so on from a given MADI Signal.
...
![reordering constraint example](images/input-constraints-block-crossover.png "Routing with blocks of 8 and crossover")
...
![reordering constraint example](images/input-constraints-block-reordering.png "Crossing Over within blocks is not permitted.")
