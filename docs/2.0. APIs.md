...
This document covers common aspects of the Audio Channel Mapping API. Many of these conventions are matched with the specification of NMOS IS-04 and IS-05. Common conventions may be refactored into a separate repository at a later date.
